...
In this tutorial, we provide step-by-step instructions on how to [use economic models](#calculate-capital-costs-(-capex-)) and [analyse the results](#results-evaluation) obtained using **Example 1** as case study (see **Figure 1**).  
